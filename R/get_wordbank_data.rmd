...
write.table(noun_freq, file = "../data/processed/childes_verb_freq.txt", sep = " ",
            row.names = FALSE)
```
...
```{r}
intersect_noun_list<-intersect(vg_nouns,wordbank_nouns$uni_lemma)
...
```{r}
intersect_verb_list<-intersect(vg_verbs,wordbank_verbs$uni_lemma)
...
noun_aoa_data
write.csv(noun_aoa_data,"../data/wordbank_noun_aoa.csv",row.names=FALSE)
```
...
verb_aoa_data
write.csv(verb_aoa_data,"../data/wordbank_verb_aoa.csv",row.names=FALSE)
```
