...
def glove_pretrained_encoder_imagenet(concepts,n_sample,cuda):
...
def glove_pretrained_encoder_openimage(concepts,n_sample,cuda):
	language_embeddings_dict=dict()
	pretrained_glove=load_pretrained_Glove()
...
def bert_pretrained_encoder_imagenet(concepts,n_sample,cuda):
