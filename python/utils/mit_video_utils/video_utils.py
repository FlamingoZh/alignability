...
def extract_frames(video_file, num_frames=8):
    ...
    # Alternative way to get length of the video
    # seconds=subprocess.Popen(['ffprobe', '-v', 'error', '-show_entries', 'format = duration', '-of', 'default=noprint_wrappers=1:nokey=1', video_file]).communicate()
